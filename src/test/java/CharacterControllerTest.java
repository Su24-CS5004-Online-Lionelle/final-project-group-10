...
class CharacterControllerTest {
    ...
    void testWriteCharacters() {
        ...
        characters.add(new CharacterRecord(37,"Beth Sanchez", "Alive", "Human", "Female","https://rickandmortyapi.com/api/character/avatar/37.jpeg"));
        characters.add(new CharacterRecord(397,"Fido", "Alive", "Animal", "Male", "https://rickandmortyapi.com/api/character/avatar/397.jpeg"));
    ...
    @Test
    void testTxtPrint() {
        CharacterRecord record = new CharacterRecord(397,"Fido", "Alive", "Animal", "Male","https://rickandmortyapi.com/api/character/avatar/397.jpeg");
